...
def dump_shp_to_json(shape_file, grid):
  ...
  geojson = open("pyshp-all-2000-sentinel-new.json", "w")
  geojson.write(dumps({"type": "FeatureCollection",\
  "features": buffer}, indent=2) + "\n")
  geojson.close()


csv_file = '/atlas/u/hanlaung/ParcelDelineation/data/sentinel/sentinel_locations_jul_sept_1991.csv'  #sentinel_locations_new_2000.csv'
